...
export async function redeemToken(
  ...
  | { ok: true; cookieValue: string; payload: HelferPayload; zielTyp: "fahrzeug" | "artikel" | null; zielId: string | null }
  | { ok: false }
> {
  ...
  return { ok: true, cookieValue, payload, zielTyp: t.zielTyp, zielId: t.zielId };
}
